...
impl HealthCache {
    ...
    pub fn get_health(&mut self, mango_group: &MangoGroup, health_type: HealthType) -> I80F48 {
        ...
        match self.health[health_index] {
            None => {
                ...
                //let (ass,lib) = self.get_health_components(mango_group, health_type);
                //assert_eq!(health, ass - lib);
                health
            }
            Some(h) => h,
        }
    ...
    pub fn get_health_components(&mut self, mango_group: &MangoGroup, health_type: HealthType) -> (I80F48, I80F48) {
